...
const AlcoholContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/sanchezbarry">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
...
const SoftwareContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/Software-Engineer-Job-Portal-Frontend">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
...
const WorkoutContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/Workouter-App">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
...
const ChurchContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/cck">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
...
const SanchezOneContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/portfolio">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
...
const SanchezTwoContent = () => {
  return (
    <>
      ...
      <Link href="https://github.com/sanchezbarry/portfolio2024">
        <button className="mr-3 shadow-[inset_0_0_0_2px_#616467] text-black px-10 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-white dark:text-neutral-200 transition duration-200">
