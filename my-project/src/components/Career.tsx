...
export function Career() {
  ...
  const data = [
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Data Wiring & Data Structures
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Understood React principles (Router, Props, etc)
            </div>
          </div>
...

    {
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Learned fullstack development (M/PERN, MVC, CRUD and more)
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Developed 4 showcase projects - more information on the projects above
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Designed with various CSS frameworks (Bootstrap, MUI, tailwind)
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Understood React principles (Router, Props, etc)
            </div>
    ...
    {
      title: "Before Software Engineering",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            I was a marketer and copywriter for more than 5 years, with a focus on the baby/juvenile industry.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Here are some interesting projects that I was a part of. 
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/spts.png"
